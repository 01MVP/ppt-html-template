...
要求：
- 在 ppt/ 文件夹中创建新的项目文件夹
- 使用现代化设计和 Tailwind CSS，良好的视觉体验，美观的过渡动画与交互元素
...
> **💡 重要提醒：** 本项目完全零依赖，**无需安装任何工具**（如 npm、python 等），直接双击 index.html 即可使用！但每次修改文件后需要刷新网页！（`Ctrl / Cmd + R` 刷新，或者浏览器左上角刷新按钮）
